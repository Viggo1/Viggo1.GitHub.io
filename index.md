...
<div class="profile">
    ...
    <div style="line-height: 1.8; font-size: 1.1em; color: #34495e;">
      ...
      <ul style="line-height: 1.8;">
        <li>技术能力：熟悉PyTorch框架、多模态数据建模、蛋白质语言模型微调</li>
        <li>工具掌握：Office、Axure、Figma、dify；常用Markdown、偏爱Claude</li>
        <li>软技能：跨域协作、项目落地、MECE问题拆解、用户需求分析、英文技术文档读写（CET-6 530+）</li>
      </ul>

      <h3 style="color: #2980b9;">📝 博客定位</h3>
      <p>分享多模态、模型微调、计算生物的学习笔记与实战踩坑，也聊聊社科心理学的思考——用技术解决实际问题，让知识有温度</p>
      ...
      <p>微信：<span class="copyable-text" data-copy="_iacgnaixihcub">_iacgnaixihcub</span></a></p>
